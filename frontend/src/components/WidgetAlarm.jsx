            ...
            {alarms.data?.map((data, id) => {
              ...
              return <div key={id}>
                ...
                <Grid container spacing={2}>
                  <List sx={{ width: '100%' }}>
                    <ListItemText sx={{ marginLeft: 2 }} primary={data.label} primaryTypographyProps={{
                      fontSize: 25,
                      fontWeight: 'bold',
                      letterSpacing: 0,
                    }}> </ListItemText>
            ...
            <Grid item xs={2} md={12}>
              <Collapsible label="Add">
                <form onSubmit={handleSubmit}>
                  ...
                  <Button type="submit" style={{ width: '100%', height: 40 }} size="small" onClick={() => createHandler()}><AddCircleIcon /></Button>
                </form>
              </Collapsible>
            </Grid>
          </Grid>
